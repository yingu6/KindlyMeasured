...
/* keep the code from wrapping so it scrolls */
.hscroll pre, .hscroll code {
  white-space: pre;
}
...
I've created a dummy dataset for showcase purposes. Now let's take a look at what fields the calendar dataset provides.
